...
## Problem
Alle Datenbank-Tabellen fehlen. App zeigt PGRST205 Fehler.
...
### Schritt 2: SQL in Blöcken ausführen

**Block 1: Tabellen erstellen**
```sql
...
**Block 3: RLS Policies (vereinfacht)**
```sql
-- Basic RLS Policies
...
### Schritt 3: Ausführen
1. **Kopiere Block 1** → Füge ein → Klicke "Run"
2. **Kopiere Block 2** → Füge ein → Klicke "Run"  
3. **Kopiere Block 3** → Füge ein → Klicke "Run"

### Schritt 4: Testen
Nach dem Ausführen aller Blöcke:
1. Gehe zu: http://localhost:3001/app
2. **Alles sollte funktionieren!** 🎉

## Was wird erstellt
- ✅ 9 Tabellen mit Beziehungen
- ✅ Row Level Security aktiviert
- ✅ User-basierte Policies
